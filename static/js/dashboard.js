...
function seedChatPreview(insight, forceReset = false) {
    ...
    thread.appendChild(createChatBubble('assistant', 'Gemini', insight.review || 'Your weekly insight is ready. Ask me anything about your mood trends!', insight.emoji || '🤖'));
...
function startCountdown(seconds, btn, el) {
    ...
    el.textContent = `Wait ${remaining}s`;
